...
namespace GrinHome.Data.Services
{
	...
	public class EmailSender : IEmailSender
	{
		...
		public EmailSender(IOptions<SmtpSenderOptions> optionsAccessor, NavigationManager Nav, IServiceProvider serviceProvider)
		{
		...
		public Task Execute(string subject, string message, string emailName, string email, string eventName)
		{
			try
			{
				var mailMessage = new MimeMessage();
				mailMessage.From.Add(new MailboxAddress("Grin Homw", Options.SmtpUser));
				mailMessage.To.Add(new MailboxAddress(emailName, email));
				mailMessage.Subject = eventName + " - " + subject;
